...
<section class="portfolio">
   ...
   <div class="portfolio-container">
      ...
      <a href="pics/events/e13.jpg" class="box">
         <div class="image">
            <img src="mvcp/rooms/ro2.jpg" alt="">
         </div>
         <div class="stars">
      ...
      <a href="pics/events/ME1.jpg" class="box">
         <div class="image">
            <img src="mvcp/rooms/ro3.jpg" alt="">
         </div>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
      ...
      <a href="pics/events/e1.jpg" class="box">
         <div class="image">
            <img src="mvcp/rooms/ro4.jpg" alt="">
         </div>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
      ...
      <a href="pics/events/e6.jpg" class="box">
         <div class="image">
            <img src="mvcp/rooms/ro5.jpg" alt="">
         </div>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
      ...
      <a href="images/port-img-6.jpg" class="box">
         <div class="image">
            <img src="mvcp/rooms/ro6.jpg" alt="">
         </div>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
      ...
      <a href="pics/events/e12.jpg" class="box">
         <div class="image">
            <img src="mvcp/rooms/ro7.jpg" alt="">
         </div>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
      ...
      <a href="pics/events/e12.jpg" class="box">
        <div class="image">
           <img src="mvcp/rooms/ro8.jpg" alt="">
        </div>
        <div class="stars">
           <i class="fas fa-star"></i>
           <i class="fas fa-star"></i>
     ...
     <a href="pics/events/e12.jpg" class="box">
        <div class="image">
           <img src="mvcp/rooms/ro9.jpg" alt="">
        </div>
        <div class="stars">
           <i class="fas fa-star"></i>
           <i class="fas fa-star"></i>
     ...
     <a href="pics/events/e12.jpg" class="box">
        <div class="image">
           <img src="mvcp/rooms/ro10.jpg" alt="">
        </div>
        <div class="stars">
           <i class="fas fa-star"></i>
           <i class="fas fa-star"></i>
...
<section class="footer">
    ...
    <div class="box-container">
       ...
       <div class="box">
          <h3>extra links</h3>
          <a href="add-post"> <i class="fas fa-angle-right"></i> plan wedding</a>
    ...
    <p class="credit"> created by | <span>wedding Saga </span> | all rights reserved! </p>
...
</html><?php /**PATH C:\xampp\htdocs\laravelp1\resources\views/room.blade.php ENDPATH**/ ?>