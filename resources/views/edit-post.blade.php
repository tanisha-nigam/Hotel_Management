...
<input type="hidden" name="id" value="{{$post->id}}"/>
      <div class="flex">
         ...
         <div class="inputBox">
            <span>your name</span>
            <input type="text" placeholder="enter your name" value="{{$post->name}}" name="name" required>
         </div>

         <div class="inputBox">
            <span>your email</span>
            <input type="email" placeholder="enter your email" value="{{$post->email}}" name="email" required>
         </div>

         <div class="inputBox">
            <span>your number</span>
            <input type="number" placeholder="enter your number" value="{{$post->number}}" name="number" required>
         </div>
        

         <div class="inputBox">
            <span>choose travel destination</span>
            <select name="destination" value="{{$post->destination}}">
         ...
         <div class="inputBox">
            ...
            <select name="hotel" value="{{$post->hotel}}">
         ...
         <div class="inputBox">
            ...
            <select name="room" value="{{$post->room}}">
         ...
         <div class="inputBox">
            ...
            <select name="meals" value="{{$post->meals}}">
         ...
         <div class="inputBox">
            ...
            <textarea name="message" placeholder="enter your message" required cols="30" rows="10">{{$post->message}}</textarea>
         </div>
